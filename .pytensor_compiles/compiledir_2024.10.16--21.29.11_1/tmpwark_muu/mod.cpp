...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb() {
        ...
        ~__struct_compiled_op_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_9;}
                ...
                V7_stride2 = (V7_n2 == 1)? 0 : PyArray_STRIDES(V7)[2] / sizeof(npy_float64);
                ...
                V7_stride0 = (V7_n0 == 1)? 0 : PyArray_STRIDES(V7)[0] / sizeof(npy_float64);
        ...
        goto __label_9;}
            ...
            non1size_dim0 = (V7_n0 != 1) ? V7_n0 : (V5_n0 != 1) ? V5_n0 : V3_n0;
            if (non1size_dim0 != 1)
            {
        
                if ((V7_n0 != non1size_dim0) && (V7_n0 != 1))
                {
        ...
        goto __label_9;}
            ...
            non1size_dim1 = (V7_n1 != 1) ? V7_n1 : (V5_n1 != 1) ? V5_n1 : V3_n1;
            if (non1size_dim1 != 1)
            {
        ...
        goto __label_9;}
            ...
            non1size_dim2 = (V7_n2 != 1) ? V7_n2 : (V5_n2 != 1) ? V5_n2 : V3_n2;
            if (non1size_dim2 != 1)
            {
        
                if ((V7_n2 != non1size_dim2) && (V7_n2 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       2,
            ...
            
{
    ...
    std::vector< std::pair<int, int> >::iterator V5_loops_it = V5_loops.begin();
        ...
        ++V5_loops_it;
            ...
            V5_loops_it->first = abs(PyArray_STRIDES(V5)[2]);
...
int init_totals[3];
init_totals[0] = (V7_n0 != 1)? V7_n0: (V5_n0 != 1)? V5_n0: V3_n0;
init_totals[1] = (V7_n1 != 1)? V7_n1: (V5_n1 != 1)? V5_n1: V3_n1;
init_totals[2] = (V7_n2 != 1)? V7_n2: (V5_n2 != 1)? V5_n2: V3_n2;
...
V3_stride0, V3_stride1, V3_stride2
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V5_loops_rit;
        ...
        V5_loops_rit = V5_loops.rbegin();
            int V7_stride_l2 = init_strides[0][V5_loops_rit->second];
            ++V5_loops_rit;
            
            int V7_stride_l1 = init_strides[0][V5_loops_rit->second];
            ++V5_loops_rit;
            
            int V7_stride_l0 = init_strides[0][V5_loops_rit->second];
            ++V5_loops_rit;
        ...
        V5_loops_rit = V5_loops.rbegin();
            int V3_stride_l2 = init_strides[2][V5_loops_rit->second];
            ++V5_loops_rit;
            
            int V3_stride_l1 = init_strides[2][V5_loops_rit->second];
            ++V5_loops_rit;
            
            int V3_stride_l0 = init_strides[2][V5_loops_rit->second];
            ++V5_loops_rit;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb_executor(__struct_compiled_op_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb *self) {
            return self->run();
        }

        static void __struct_compiled_op_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb_destructor(PyObject *capsule) {
            __struct_compiled_op_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb *self = (__struct_compiled_op_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb* struct_ptr = new __struct_compiled_op_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb_executor), NULL, __struct_compiled_op_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_me4a527f80e0a6ba2d4cf2dde3b549696d8968a1162636fd70a5fc3e99d0bc7bb(void) {
   import_array();
