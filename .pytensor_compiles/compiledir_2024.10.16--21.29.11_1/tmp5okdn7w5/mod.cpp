...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e() {
        ...
        ~__struct_compiled_op_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e(void) {
            cleanup();
        }
...
goto __label_11;};
        ...
        if (py_V7 != Py_None){
            dtype_V7 shp = ((dtype_V7*)PyArray_GETPTR1(V7, 0))[0];
            if (PyArray_DIMS(V9)[0] != shp) {
                PyErr_Format(PyExc_AssertionError,
                    "SpecifyShape: dim %d of input has shape %d, expected %d.",
                    0, PyArray_DIMS(V9)[0], shp
                );
                {
__failure = 11;
if (!PyErr_Occurred()) {
...
goto __label_11;};
        ...
        if (py_V5 != Py_None){
            dtype_V5 shp = ((dtype_V5*)PyArray_GETPTR1(V5, 0))[0];
            if (PyArray_DIMS(V9)[1] != shp) {
                PyErr_Format(PyExc_AssertionError,
                    "SpecifyShape: dim %d of input has shape %d, expected %d.",
                    1, PyArray_DIMS(V9)[1], shp
                );
                {
__failure = 11;
if (!PyErr_Occurred()) {
...
goto __label_11;};
        ...
        if (py_V3 != Py_None){
            dtype_V3 shp = ((dtype_V3*)PyArray_GETPTR1(V3, 0))[0];
            if (PyArray_DIMS(V9)[2] != shp) {
                PyErr_Format(PyExc_AssertionError,
                    "SpecifyShape: dim %d of input has shape %d, expected %d.",
                    2, PyArray_DIMS(V9)[2], shp
                );
                {
__failure = 11;
if (!PyErr_Occurred()) {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e_executor(__struct_compiled_op_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e *self) {
            return self->run();
        }

        static void __struct_compiled_op_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e_destructor(PyObject *capsule) {
            __struct_compiled_op_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e *self = (__struct_compiled_op_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e* struct_ptr = new __struct_compiled_op_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e_executor), NULL, __struct_compiled_op_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m9252af9262202303fa085ab712cb83f187c0bf83072e0c25a9d00a4f3a6b109e(void) {
   import_array();
