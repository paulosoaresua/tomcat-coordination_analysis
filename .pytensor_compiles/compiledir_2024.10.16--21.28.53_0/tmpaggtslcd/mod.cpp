...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1 {
        PyObject* __ERROR;
...
PyObject* storage_V7;
    ...
    PyObject* py_V7;
        ...
        __struct_compiled_op_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1() {
        ...
        ~__struct_compiled_op_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1(void) {
            cleanup();
        }
...
// Op class Assert
            ...
            if(PyObject_IsTrue((PyObject *)V3) == 0) {
                ...
                Py_INCREF(exc_type);
                PyErr_SetString(exc_type, "Shapes must be equal");
                Py_XDECREF(exc_type);
                    {
            __failure = 9;
            if (!PyErr_Occurred()) {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1_executor(__struct_compiled_op_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1_destructor(PyObject *capsule) {
            __struct_compiled_op_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1 *self = (__struct_compiled_op_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1* struct_ptr = new __struct_compiled_op_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1_executor), NULL, __struct_compiled_op_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m710bd6534de731a2bc3764b6cc3dda5df11ea971e56051215178edf6cc2d1fc1(void) {
   import_array();
