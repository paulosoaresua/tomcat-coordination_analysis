...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7() {
        ...
        ~__struct_compiled_op_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_7;}
                ...
                V3_stride2 = (V3_n2 == 1)? 0 : PyArray_STRIDES(V3)[2] / sizeof(npy_float64);
                ...
                V3_stride0 = (V3_n0 == 1)? 0 : PyArray_STRIDES(V3)[0] / sizeof(npy_float64);
                V3_jump0_0 = (V3_stride0) - (V3_n1*V3_stride1);
                
            npy_intp non1size_dim0;
            non1size_dim0 = (V5_n0 != 1) ? V5_n0 : V3_n0;
            if (non1size_dim0 != 1)
            {
        ...
        goto __label_7;}
                ...
                if ((V3_n0 != non1size_dim0) && (V3_n0 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       0,
                       (long long int) non1size_dim0,
        ...
        goto __label_7;}
            ...
            non1size_dim1 = (V5_n1 != 1) ? V5_n1 : V3_n1;
            if (non1size_dim1 != 1)
            {
        ...
        goto __label_7;}
            ...
            non1size_dim2 = (V5_n2 != 1) ? V5_n2 : V3_n2;
            if (non1size_dim2 != 1)
            {
        
                if ((V5_n2 != non1size_dim2) && (V5_n2 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       2,
        ...
        goto __label_7;}
                ...
                if ((V3_n2 != non1size_dim2) && (V3_n2 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       2,
                       (long long int) non1size_dim2,
                ...
                
    {
        ...
        dims[0] = (V5_n0 != 1)? V5_n0: V3_n0;
dims[1] = (V5_n1 != 1)? V5_n1: V3_n1;
dims[2] = (V5_n2 != 1)? V5_n2: V3_n2;

        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(3, dims,
                                                    NPY_FLOAT64,
                                                    PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V3));
        }
        else {
...
int init_totals[3];
init_totals[0] = (V5_n0 != 1)? V5_n0: (V3_n0 != 1)? V3_n0: V1_n0;
init_totals[1] = (V5_n1 != 1)? V5_n1: (V3_n1 != 1)? V3_n1: V1_n1;
init_totals[2] = (V5_n2 != 1)? V5_n2: (V3_n2 != 1)? V3_n2: V1_n2;
    ...
    int init_strides[3][3] = {
        V5_stride0, V5_stride1, V5_stride2, 
...
V1_stride0, V1_stride1, V1_stride2
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V5_stride_l2 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V5_stride_l1 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V5_stride_l0 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V3_stride_l2 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V3_stride_l1 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V3_stride_l0 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l2 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7_executor(__struct_compiled_op_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7_destructor(PyObject *capsule) {
            __struct_compiled_op_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7 *self = (__struct_compiled_op_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7* struct_ptr = new __struct_compiled_op_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7_executor), NULL, __struct_compiled_op_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m709aeae2ce35f900d1546fd559cd62845804c1f052cd0c687b4d30fb31bec5f7(void) {
   import_array();
