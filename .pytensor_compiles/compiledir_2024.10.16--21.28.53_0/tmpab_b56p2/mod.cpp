...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249() {
        ...
        ~__struct_compiled_op_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249(void) {
            cleanup();
        }
        ...
        
    {
        ...
        if (!V1) {
            ...
            if (!success) {
                ...
                PyErr_Clear();
                Py_XDECREF(V1);
                V1 = (PyArrayObject*)PyArray_EMPTY(0, dims, NPY_INT32, 0);
            } else {
                Py_DECREF(success);
            }
        }
...
V1_iter = (npy_int32*)(PyArray_DATA(V1));

                  npy_int8& V3_i = *V3_iter;
npy_int32& V1_i = *V1_iter;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249_executor(__struct_compiled_op_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249_destructor(PyObject *capsule) {
            __struct_compiled_op_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249 *self = (__struct_compiled_op_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249* struct_ptr = new __struct_compiled_op_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249_executor), NULL, __struct_compiled_op_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m1e6a064bed5c23d262b14acb5f94abb1a5e803613a256eae0024c51401194249(void) {
   import_array();
