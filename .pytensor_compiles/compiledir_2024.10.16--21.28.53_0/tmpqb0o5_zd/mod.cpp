...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59() {
        ...
        ~__struct_compiled_op_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59(void) {
            cleanup();
        }
            ...
            
{
    ...
    {Py_XINCREF(py_V1);}
        ...
        goto __label_2;}
            ...
            if (PyArray_TYPE((PyArrayObject*) py_V1) != NPY_INT8) {
                PyErr_Format(PyExc_TypeError,
                             "expected type_num %d (NPY_INT8) got %d",
                             NPY_INT8, PyArray_TYPE((PyArrayObject*) py_V1));
                {
        __failure = 2;
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_RuntimeError,
        ...
        
    {
        ...
        if (!V1) {
            ...
            if (!success) {
                ...
                PyErr_Clear();
                Py_XDECREF(V1);
                V1 = (PyArrayObject*)PyArray_EMPTY(0, dims, NPY_INT8, 0);
            } else {
                Py_DECREF(success);
            }
        }
...
V1_iter = (npy_int8*)(PyArray_DATA(V1));

                  npy_bool& V7_i = *V7_iter;
npy_int8& V5_i = *V5_iter;
npy_int8& V3_i = *V3_iter;
npy_int8& V1_i = *V1_iter;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59_executor(__struct_compiled_op_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59 *self) {
            return self->run();
        }

        static void __struct_compiled_op_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59_destructor(PyObject *capsule) {
            __struct_compiled_op_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59 *self = (__struct_compiled_op_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59* struct_ptr = new __struct_compiled_op_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59_executor), NULL, __struct_compiled_op_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_mb7a7ea25b61c762608de5e13b19b60b447153a934573b689ef7bd57f4dee9a59(void) {
   import_array();
