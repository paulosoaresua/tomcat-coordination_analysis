...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb() {
        ...
        ~__struct_compiled_op_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb(void) {
            cleanup();
        }
...
subtensor_spec[4] = V3;;
        ...
        for (; outer_ii < 3; ++outer_ii)
        {
            ...
            {
                npy_intp length = PyArray_DIMS(V7)[outer_ii];
        ...
        goto __label_9;};
                ...
                xview_offset += (npy_intp)PyArray_STRIDES(V7)[outer_ii]
                    * start * 1;
                xview_dims[inner_ii] = slicelength;
                xview_strides[inner_ii] = (npy_intp)PyArray_STRIDES(V7)[outer_ii] * step;
            ...
            else // tuple coord `outer_ii` is an int
            {
                ...
                if (idx < 0) idx += PyArray_DIMS(V7)[outer_ii];
                if (idx >= 0)
                {
                    if (idx < PyArray_DIMS(V7)[outer_ii])
                    {
                        xview_offset += (npy_intp)PyArray_STRIDES(V7)[outer_ii] * idx *
                               1;
                    }
                    else
                    {
        ...
        while (inner_ii < 1)
        {
            assert (outer_ii < PyArray_NDIM(V7));
            xview_dims[inner_ii] = PyArray_DIMS(V7)[outer_ii];
            xview_strides[inner_ii] = PyArray_STRIDES(V7)[outer_ii];
        ...
        Py_XDECREF(V1);
        Py_INCREF(py_V7);
        PyArray_SetBaseObject(xview, py_V7);
        assert(py_V7 == (PyObject*)V7);
        V1 = xview;
        }__label_9:
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb_executor(__struct_compiled_op_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb *self) {
            return self->run();
        }

        static void __struct_compiled_op_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb_destructor(PyObject *capsule) {
            __struct_compiled_op_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb *self = (__struct_compiled_op_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb* struct_ptr = new __struct_compiled_op_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb_executor), NULL, __struct_compiled_op_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m9e7fcd9ec858272e05f960939cf0e9eab9eef63f7b38c73a9d8c9559647822bb(void) {
   import_array();
