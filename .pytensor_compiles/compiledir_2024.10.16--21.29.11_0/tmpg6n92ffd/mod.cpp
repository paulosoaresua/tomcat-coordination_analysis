...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4() {
        ...
        ~__struct_compiled_op_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_7;}
            ...
            if((PyArray_ISCONTIGUOUS(V5) && PyArray_ISCONTIGUOUS(V3) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V1))){
...
int init_totals[3];
init_totals[0] = (V5_n0 != 1)? V5_n0: V3_n0;
init_totals[1] = (V5_n1 != 1)? V5_n1: V3_n1;
init_totals[2] = (V5_n2 != 1)? V5_n2: V3_n2;
...
V3_stride0, V3_stride1, V3_stride2
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V3_loops_rit;
        ...
        V3_loops_rit = V3_loops.rbegin();
            int V5_stride_l2 = init_strides[0][V3_loops_rit->second];
            ++V3_loops_rit;
            
            int V5_stride_l1 = init_strides[0][V3_loops_rit->second];
            ++V3_loops_rit;
            
            int V5_stride_l0 = init_strides[0][V3_loops_rit->second];
            ++V3_loops_rit;
            
        V3_loops_rit = V3_loops.rbegin();
            int V3_stride_l2 = init_strides[1][V3_loops_rit->second];
            ++V3_loops_rit;
            
            int V3_stride_l1 = init_strides[1][V3_loops_rit->second];
            ++V3_loops_rit;
            
            int V3_stride_l0 = init_strides[1][V3_loops_rit->second];
            ++V3_loops_rit;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4_executor(__struct_compiled_op_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4_destructor(PyObject *capsule) {
            __struct_compiled_op_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4 *self = (__struct_compiled_op_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4* struct_ptr = new __struct_compiled_op_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4_executor), NULL, __struct_compiled_op_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m64972936dc65262232af9881b985fa80a11b25c2a48bd75eed52e1f5e2cd6bc4(void) {
   import_array();
