...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0() {
        ...
        ~__struct_compiled_op_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0(void) {
            cleanup();
        }
...
dims[1] = 1;
        ...
        if (!V1) {
            ...
            if (!success) {
                ...
                PyErr_Clear();
                Py_XDECREF(V1);
                V1 = (PyArrayObject*)PyArray_EMPTY(2, dims, NPY_BOOL, 0);
            } else {
                Py_DECREF(success);
            }
        }
...
npy_bool &V1_i = * ( V1_iter+V1_stride_l1*ITER_1+V1_stride_l0*ITER_0);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0_executor(__struct_compiled_op_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0_destructor(PyObject *capsule) {
            __struct_compiled_op_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0 *self = (__struct_compiled_op_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0* struct_ptr = new __struct_compiled_op_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0_executor), NULL, __struct_compiled_op_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m163e4a920b367e009e8c58bb285d006895d3bc8ec2f2c7aefaff46da430c9cd0(void) {
   import_array();
