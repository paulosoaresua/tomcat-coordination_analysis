...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce() {
        ...
        ~__struct_compiled_op_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce(void) {
            cleanup();
        }
...
V1_stride0, V1_stride1, V1_stride2
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V7_stride_l2 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V7_stride_l1 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V7_stride_l0 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V5_stride_l2 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V3_stride_l2 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V3_stride_l1 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V3_stride_l0 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l2 = init_strides[3][V1_loops_rit->second];
            ++V1_loops_rit;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce_executor(__struct_compiled_op_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce *self) {
            return self->run();
        }

        static void __struct_compiled_op_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce_destructor(PyObject *capsule) {
            __struct_compiled_op_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce *self = (__struct_compiled_op_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce* struct_ptr = new __struct_compiled_op_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce_executor), NULL, __struct_compiled_op_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m86488edcc1be7ef7fcc2750640dd13731a4b03f9809e41f8cc654ee9b085a3ce(void) {
   import_array();
