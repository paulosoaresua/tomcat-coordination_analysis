...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af() {
        ...
        ~__struct_compiled_op_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af(void) {
            cleanup();
        }

        int init(PyObject* __ERROR, PyObject* storage_V15, PyObject* storage_V13, PyObject* storage_V11, PyObject* storage_V9, PyObject* storage_V7, PyObject* storage_V5, PyObject* storage_V3, PyObject* storage_V1) {
...
0, 0
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V7_loops_rit;
        ...
        V7_loops_rit = V7_loops.rbegin();
            int V15_stride_l1 = init_strides[0][V7_loops_rit->second];
            ++V7_loops_rit;
            
            int V15_stride_l0 = init_strides[0][V7_loops_rit->second];
            ++V7_loops_rit;
            
        V7_loops_rit = V7_loops.rbegin();
            int V13_stride_l1 = init_strides[1][V7_loops_rit->second];
            ++V7_loops_rit;
            
            int V13_stride_l0 = init_strides[1][V7_loops_rit->second];
            ++V7_loops_rit;
            
        V7_loops_rit = V7_loops.rbegin();
            int V11_stride_l1 = init_strides[2][V7_loops_rit->second];
            ++V7_loops_rit;
            
            int V11_stride_l0 = init_strides[2][V7_loops_rit->second];
            ++V7_loops_rit;
        ...
        V7_loops_rit = V7_loops.rbegin();
            int V7_stride_l1 = init_strides[4][V7_loops_rit->second];
            ++V7_loops_rit;
            
            int V7_stride_l0 = init_strides[4][V7_loops_rit->second];
            ++V7_loops_rit;
            
        V7_loops_rit = V7_loops.rbegin();
            int V5_stride_l1 = init_strides[5][V7_loops_rit->second];
            ++V7_loops_rit;
            
            int V5_stride_l0 = init_strides[5][V7_loops_rit->second];
            ++V7_loops_rit;
            
        V7_loops_rit = V7_loops.rbegin();
            int V3_stride_l1 = init_strides[6][V7_loops_rit->second];
            ++V7_loops_rit;
            
            int V3_stride_l0 = init_strides[6][V7_loops_rit->second];
            ++V7_loops_rit;
            
V15_iter = (npy_bool*)(PyArray_DATA(V15));
...
V3_iter = (npy_float64*)(PyArray_DATA(V3));
        ...
        { // begin loop 1
            npy_bool &V15_i = * ( V15_iter+V15_stride_l1*ITER_1+V15_stride_l0*ITER_0);
...
npy_int8 &V9_i = * ( V9_iter+V9_stride_l1*ITER_1+V9_stride_l0*ITER_0);
...
npy_float64 &V3_i = * ( V3_iter+V3_stride_l1*ITER_1+V3_stride_l0*ITER_0);
            ...
            
        {
            ...
            {
npy_float64 V17_tmp1;
V17_tmp1 = V7_i * V11_i;
npy_float64 V17_tmp2;
V17_tmp2 = V13_i * V11_i * V11_i;
npy_float64 V17_tmp3;
V17_tmp3 = V15_i ? V17_tmp2 : V9_i;
V1_i = V17_tmp3 + V17_tmp1 + V5_i + V3_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af_executor(__struct_compiled_op_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af *self) {
            return self->run();
        }

        static void __struct_compiled_op_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af_destructor(PyObject *capsule) {
            __struct_compiled_op_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af *self = (__struct_compiled_op_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af* struct_ptr = new __struct_compiled_op_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af_executor), NULL, __struct_compiled_op_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m4e605599e645bf69bbd1568b29cdaf8bb7681df4b081603d79e37a9a57e914af(void) {
   import_array();
