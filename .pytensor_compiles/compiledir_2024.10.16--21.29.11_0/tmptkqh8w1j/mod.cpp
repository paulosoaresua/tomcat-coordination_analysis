...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572() {
        ...
        ~__struct_compiled_op_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572(void) {
            cleanup();
        }

        int init(PyObject* __ERROR, PyObject* storage_V17, PyObject* storage_V7, PyObject* storage_V15, PyObject* storage_V13, PyObject* storage_V11, PyObject* storage_V9, PyObject* storage_V5, PyObject* storage_V3, PyObject* storage_V1) {
...
npy_int8 &V13_i = * ( V13_iter + ITER_0 * V13_jumpx_0 );
...
V19_tmp3 = V7_i * V15_i * V15_i;
npy_float64 V19_tmp4;
V19_tmp4 = V17_i ? V19_tmp3 : V13_i;
V1_i = V19_tmp4 + V11_i + V19_tmp2 + V7_i + V19_tmp1 + V3_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572_executor(__struct_compiled_op_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572_destructor(PyObject *capsule) {
            __struct_compiled_op_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572 *self = (__struct_compiled_op_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572* struct_ptr = new __struct_compiled_op_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8),PyTuple_GET_ITEM(argtuple, 9) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572_executor), NULL, __struct_compiled_op_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m3e5cbc4f6d572e6d72a39e22906195d6d10d399319a80cbfc517383153be4572(void) {
   import_array();
