...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563() {
        ...
        ~__struct_compiled_op_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563(void) {
            cleanup();
        }

        int init(PyObject* __ERROR, PyObject* storage_V17, PyObject* storage_V15, PyObject* storage_V13, PyObject* storage_V11, PyObject* storage_V9, PyObject* storage_V7, PyObject* storage_V5, PyObject* storage_V3, PyObject* storage_V1) {
        ...
        
{
    ...
    {Py_XINCREF(py_V17);}
        ...
        goto __label_18;}
            ...
            // This is a TypeError to be consistent with DEBUG_MODE
            // Note: DEBUG_MODE also tells the name of the container
            if (PyArray_TYPE((PyArrayObject*) py_V17) != NPY_BOOL) {
                PyErr_Format(PyExc_TypeError,
                             "expected type_num %d (NPY_BOOL) got %d",
                             NPY_BOOL, PyArray_TYPE((PyArrayObject*) py_V17));
                {
        __failure = 18;
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_RuntimeError,
...
// Op class Elemwise
        ...
        goto __label_19;}
            ...
            non1size_dim0 = (V13_n0 != 1) ? V13_n0 : V11_n0;
            if (non1size_dim0 != 1)
            {
        ...
        goto __label_19;}
            ...
            non1size_dim1 = (V13_n1 != 1) ? V13_n1 : V11_n1;
            if (non1size_dim1 != 1)
            {
        ...
        goto __label_19;}
            ...
            non1size_dim2 = (V13_n2 != 1) ? V13_n2 : V11_n2;
            if (non1size_dim2 != 1)
            {
                ...
                
    {
        ...
        dims[0] = (V13_n0 != 1)? V13_n0: V11_n0;
dims[1] = (V13_n1 != 1)? V13_n1: V11_n1;
dims[2] = (V13_n2 != 1)? V13_n2: V11_n2;

        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(3, dims,
                                                    NPY_FLOAT64,
                                                    PyArray_ISFORTRAN(V13) && PyArray_ISFORTRAN(V11));
        }
        else {
...
int init_totals[3];
init_totals[0] = (V13_n0 != 1)? V13_n0: (V11_n0 != 1)? V11_n0: V1_n0;
init_totals[1] = (V13_n1 != 1)? V13_n1: (V11_n1 != 1)? V11_n1: V1_n1;
init_totals[2] = (V13_n2 != 1)? V13_n2: (V11_n2 != 1)? V11_n2: V1_n2;
...
V1_stride0, V1_stride1, V1_stride2
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V17_stride_l2 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V17_stride_l1 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V17_stride_l0 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V15_stride_l2 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V15_stride_l1 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V15_stride_l0 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V13_stride_l2 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V13_stride_l1 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V13_stride_l0 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V11_stride_l2 = init_strides[3][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V11_stride_l1 = init_strides[3][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V11_stride_l0 = init_strides[3][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V9_stride_l2 = init_strides[4][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V9_stride_l1 = init_strides[4][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V9_stride_l0 = init_strides[4][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V7_stride_l2 = init_strides[5][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V7_stride_l1 = init_strides[5][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V7_stride_l0 = init_strides[5][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V5_stride_l2 = init_strides[6][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V5_stride_l1 = init_strides[6][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V5_stride_l0 = init_strides[6][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V3_stride_l2 = init_strides[7][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V3_stride_l1 = init_strides[7][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V3_stride_l0 = init_strides[7][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l2 = init_strides[8][V1_loops_rit->second];
            ++V1_loops_rit;
...
V17_iter = (npy_bool*)(PyArray_DATA(V17));
...
V1_iter = (npy_float64*)(PyArray_DATA(V1));
        ...
        { // begin loop 2
            npy_bool &V17_i = * ( V17_iter+V17_stride_l2*ITER_2+V17_stride_l1*ITER_1+V17_stride_l0*ITER_0);
...
npy_float64 &V1_i = * ( V1_iter+V1_stride_l2*ITER_2+V1_stride_l1*ITER_1+V1_stride_l0*ITER_0);
            ...
            
        {
            ...
            {
npy_float64 V19_tmp1;
V19_tmp1 = V13_i - V11_i;
npy_float64 V19_tmp2;
V19_tmp2 = V19_tmp1 / V9_i;
npy_float64 V19_tmp3;
V19_tmp3 = V19_tmp2 * V19_tmp2;
npy_float64 V19_tmp4;
V19_tmp4 = V15_i * V19_tmp3;
npy_float64 V19_tmp5;
V19_tmp5 = V19_tmp4 - V7_i;
npy_float64 V19_tmp6;
V19_tmp6 = V19_tmp5 - V5_i;
V1_i = V17_i ? V19_tmp6 : V3_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563_executor(__struct_compiled_op_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563_destructor(PyObject *capsule) {
            __struct_compiled_op_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563 *self = (__struct_compiled_op_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563* struct_ptr = new __struct_compiled_op_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8),PyTuple_GET_ITEM(argtuple, 9) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563_executor), NULL, __struct_compiled_op_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m8a09f91dc0e82ff13fdeeb7c60978eaf2caa8b329207107e4dce0269be77f563(void) {
   import_array();
