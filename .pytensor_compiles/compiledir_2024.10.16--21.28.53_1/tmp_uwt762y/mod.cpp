...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50() {
        ...
        ~__struct_compiled_op_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50(void) {
            cleanup();
        }

        int init(PyObject* __ERROR, PyObject* storage_V19, PyObject* storage_V17, PyObject* storage_V15, PyObject* storage_V13, PyObject* storage_V11, PyObject* storage_V9, PyObject* storage_V7, PyObject* storage_V5, PyObject* storage_V3, PyObject* storage_V1) {
        ...
        
{
    ...
    {Py_XINCREF(py_V19);}
        ...
        goto __label_20;}
            ...
            // This is a TypeError to be consistent with DEBUG_MODE
            // Note: DEBUG_MODE also tells the name of the container
            if (PyArray_TYPE((PyArrayObject*) py_V19) != NPY_BOOL) {
                PyErr_Format(PyExc_TypeError,
                             "expected type_num %d (NPY_BOOL) got %d",
                             NPY_BOOL, PyArray_TYPE((PyArrayObject*) py_V19));
                {
        __failure = 20;
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_RuntimeError,
...
// Op class Elemwise
        ...
        goto __label_21;}
                ...
                V15_stride2 = (V15_n2 == 1)? 0 : PyArray_STRIDES(V15)[2] / sizeof(npy_float64);
                V15_jump2_2 = (V15_stride2) - (0);
                
                V15_n1 = PyArray_DIMS(V15)[1];
                V15_stride1 = (V15_n1 == 1)? 0 : PyArray_STRIDES(V15)[1] / sizeof(npy_float64);
                V15_jump1_1 = (V15_stride1) - (V15_n2*V15_stride2);
                
                V15_n0 = PyArray_DIMS(V15)[0];
                V15_stride0 = (V15_n0 == 1)? 0 : PyArray_STRIDES(V15)[0] / sizeof(npy_float64);
        ...
        goto __label_21;}
                ...
                V13_stride2 = (V13_n2 == 1)? 0 : PyArray_STRIDES(V13)[2] / sizeof(npy_float64);
                V13_jump2_2 = (V13_stride2) - (0);
                
                V13_n1 = PyArray_DIMS(V13)[1];
                V13_stride1 = (V13_n1 == 1)? 0 : PyArray_STRIDES(V13)[1] / sizeof(npy_float64);
                V13_jump1_1 = (V13_stride1) - (V13_n2*V13_stride2);
                
                V13_n0 = PyArray_DIMS(V13)[0];
                V13_stride0 = (V13_n0 == 1)? 0 : PyArray_STRIDES(V13)[0] / sizeof(npy_float64);
        ...
        goto __label_21;}
                ...
                V11_stride2 = (V11_n2 == 1)? 0 : PyArray_STRIDES(V11)[2] / sizeof(npy_float64);
                ...
                V11_stride0 = (V11_n0 == 1)? 0 : PyArray_STRIDES(V11)[0] / sizeof(npy_float64);
        ...
        goto __label_21;}
                ...
                V9_stride0 = (V9_n0 == 1)? 0 : PyArray_STRIDES(V9)[0] / sizeof(npy_float64);
        ...
        goto __label_21;}
                ...
                V5_stride0 = (V5_n0 == 1)? 0 : PyArray_STRIDES(V5)[0] / sizeof(npy_float64);
            ...
            npy_intp non1size_dim0;
            non1size_dim0 = (V15_n0 != 1) ? V15_n0 : (V13_n0 != 1) ? V13_n0 : (V11_n0 != 1) ? V11_n0 : (V9_n0 != 1) ? V9_n0 : V5_n0;
            if (non1size_dim0 != 1)
            {
        
                if ((V15_n0 != non1size_dim0) && (V15_n0 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       0,
                       (long long int) non1size_dim0,
                       2,
                       0,
                       (long long int) V15_n0
                    );
                    {
        __failure = 21;
        if (!PyErr_Occurred()) {
        ...
        goto __label_21;}
                ...
                if ((V13_n0 != non1size_dim0) && (V13_n0 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       0,
                       (long long int) non1size_dim0,
        ...
        goto __label_21;}
                ...
                if ((V11_n0 != non1size_dim0) && (V11_n0 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       0,
                       (long long int) non1size_dim0,
        ...
        goto __label_21;}
                ...
                if ((V9_n0 != non1size_dim0) && (V9_n0 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       0,
                       (long long int) non1size_dim0,
        ...
        goto __label_21;}
                ...
                if ((V5_n0 != non1size_dim0) && (V5_n0 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       0,
                       (long long int) non1size_dim0,
        ...
        goto __label_21;}
            ...
            non1size_dim1 = (V15_n1 != 1) ? V15_n1 : (V13_n1 != 1) ? V13_n1 : V11_n1;
            if (non1size_dim1 != 1)
            {
        
                if ((V15_n1 != non1size_dim1) && (V15_n1 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       1,
        ...
        goto __label_21;}
                ...
                if ((V13_n1 != non1size_dim1) && (V13_n1 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       1,
                       (long long int) non1size_dim1,
        ...
        goto __label_21;}
            ...
            npy_intp non1size_dim2;
            non1size_dim2 = (V15_n2 != 1) ? V15_n2 : (V13_n2 != 1) ? V13_n2 : V11_n2;
            if (non1size_dim2 != 1)
            {
        
                if ((V15_n2 != non1size_dim2) && (V15_n2 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       2,
                       (long long int) non1size_dim2,
                       2,
                       2,
                       (long long int) V15_n2
                    );
                    {
        __failure = 21;
        if (!PyErr_Occurred()) {
        ...
        goto __label_21;}
                ...
                if ((V13_n2 != non1size_dim2) && (V13_n2 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       2,
                       (long long int) non1size_dim2,
        ...
        goto __label_21;}
                ...
                if ((V11_n2 != non1size_dim2) && (V11_n2 != 1))
                {
                    PyErr_Format(PyExc_ValueError, "Input dimension mismatch. One other input has shape[%i] = %lld, but input[%i].shape[%i] = %lld.",
                       2,
                       (long long int) non1size_dim2,
                ...
                
    {
        ...
        dims[0] = (V15_n0 != 1)? V15_n0: (V13_n0 != 1)? V13_n0: (V11_n0 != 1)? V11_n0: (V9_n0 != 1)? V9_n0: V5_n0;
dims[1] = (V15_n1 != 1)? V15_n1: (V13_n1 != 1)? V13_n1: V11_n1;
dims[2] = (V15_n2 != 1)? V15_n2: (V13_n2 != 1)? V13_n2: V11_n2;

        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(3, dims,
                                                    NPY_FLOAT64,
                                                    PyArray_ISFORTRAN(V15) && PyArray_ISFORTRAN(V13) && PyArray_ISFORTRAN(V11) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V5));
        }
        else {
            ...
            if (!success) {
                ...
                PyErr_Clear();
                Py_XDECREF(V1);
                V1 = (PyArrayObject*)PyArray_EMPTY(3, dims, NPY_FLOAT64, 0);
            } else {
                Py_DECREF(success);
            }
        }
        ...
        goto __label_21;}
                ...
                V1_n2 = PyArray_DIMS(V1)[2];
                V1_stride2 = (V1_n2 == 1)? 0 : PyArray_STRIDES(V1)[2] / sizeof(npy_float64);
                V1_jump2_2 = (V1_stride2) - (0);
                
                V1_n1 = PyArray_DIMS(V1)[1];
                V1_stride1 = (V1_n1 == 1)? 0 : PyArray_STRIDES(V1)[1] / sizeof(npy_float64);
                V1_jump1_1 = (V1_stride1) - (V1_n2*V1_stride2);
                
                V1_n0 = PyArray_DIMS(V1)[0];
                V1_stride0 = (V1_n0 == 1)? 0 : PyArray_STRIDES(V1)[0] / sizeof(npy_float64);
                V1_jump0_0 = (V1_stride0) - (V1_n1*V1_stride1);
                
{

    std::vector< std::pair<int, int> > V1_loops(3);
    std::vector< std::pair<int, int> >::iterator V1_loops_it = V1_loops.begin();
        ...
        ++V1_loops_it;
            ...
            V1_loops_it->first = abs(PyArray_STRIDES(V1)[2]);
            
        V1_loops_it->second = 2;
        ++V1_loops_it;
...
int init_totals[3];
init_totals[0] = (V15_n0 != 1)? V15_n0: (V13_n0 != 1)? V13_n0: (V11_n0 != 1)? V11_n0: (V9_n0 != 1)? V9_n0: (V5_n0 != 1)? V5_n0: V1_n0;
init_totals[1] = (V15_n1 != 1)? V15_n1: (V13_n1 != 1)? V13_n1: (V11_n1 != 1)? V11_n1: V1_n1;
init_totals[2] = (V15_n2 != 1)? V15_n2: (V13_n2 != 1)? V13_n2: (V11_n2 != 1)? V11_n2: V1_n2;
    ...
    V1_loops_it = V1_loops.begin();
        ...
        int TOTAL_2 = init_totals[V1_loops_it->second];
        ++V1_loops_it;
        

    int init_strides[10][3] = {
        0, 0, 0, 
0, 0, 0, 
V15_stride0, V15_stride1, V15_stride2, 
V13_stride0, V13_stride1, V13_stride2, 
V11_stride0, V11_stride1, V11_stride2, 
V9_stride0, 0, 0, 
0, 0, 0, 
V5_stride0, 0, 0, 
0, 0, 0, 
V1_stride0, V1_stride1, V1_stride2
    };
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
    
        V1_loops_rit = V1_loops.rbegin();
            int V19_stride_l2 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V19_stride_l1 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V19_stride_l0 = init_strides[0][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V17_stride_l2 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V17_stride_l1 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V17_stride_l0 = init_strides[1][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V15_stride_l2 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V15_stride_l1 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V15_stride_l0 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V13_stride_l2 = init_strides[3][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V13_stride_l1 = init_strides[3][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V13_stride_l0 = init_strides[3][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V11_stride_l2 = init_strides[4][V1_loops_rit->second];
            ++V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V9_stride_l2 = init_strides[5][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V9_stride_l1 = init_strides[5][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V9_stride_l0 = init_strides[5][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V7_stride_l2 = init_strides[6][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V7_stride_l1 = init_strides[6][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V7_stride_l0 = init_strides[6][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V5_stride_l2 = init_strides[7][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V5_stride_l1 = init_strides[7][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V5_stride_l0 = init_strides[7][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V3_stride_l2 = init_strides[8][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V3_stride_l1 = init_strides[8][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V3_stride_l0 = init_strides[8][V1_loops_rit->second];
            ++V1_loops_rit;
            
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l2 = init_strides[9][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V1_stride_l1 = init_strides[9][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V1_stride_l0 = init_strides[9][V1_loops_rit->second];
            ++V1_loops_rit;
            
V19_iter = (npy_bool*)(PyArray_DATA(V19));
...
V1_iter = (npy_float64*)(PyArray_DATA(V1));
        ...
        { // begin loop 2
            npy_bool &V19_i = * ( V19_iter+V19_stride_l2*ITER_2+V19_stride_l1*ITER_1+V19_stride_l0*ITER_0);
npy_float64 &V17_i = * ( V17_iter+V17_stride_l2*ITER_2+V17_stride_l1*ITER_1+V17_stride_l0*ITER_0);
npy_float64 &V15_i = * ( V15_iter+V15_stride_l2*ITER_2+V15_stride_l1*ITER_1+V15_stride_l0*ITER_0);
npy_float64 &V13_i = * ( V13_iter+V13_stride_l2*ITER_2+V13_stride_l1*ITER_1+V13_stride_l0*ITER_0);
...
npy_float64 &V1_i = * ( V1_iter+V1_stride_l2*ITER_2+V1_stride_l1*ITER_1+V1_stride_l0*ITER_0);

            
        {
            
            {
npy_float64 V21_tmp1;
V21_tmp1 = V13_i + V11_i;
npy_float64 V21_tmp2;
V21_tmp2 = V15_i - V21_tmp1;
npy_float64 V21_tmp3;
V21_tmp3 = V21_tmp2 / V9_i;
npy_float64 V21_tmp4;
V21_tmp4 = V21_tmp3 * V21_tmp3;
npy_float64 V21_tmp5;
V21_tmp5 = V17_i * V21_tmp4;
npy_float64 V21_tmp6;
V21_tmp6 = V21_tmp5 - V7_i;
npy_float64 V21_tmp7;
V21_tmp7 = V21_tmp6 - V5_i;
V1_i = V19_i ? V21_tmp7 : V3_i;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50_executor(__struct_compiled_op_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50_destructor(PyObject *capsule) {
            __struct_compiled_op_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50 *self = (__struct_compiled_op_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50* struct_ptr = new __struct_compiled_op_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8),PyTuple_GET_ITEM(argtuple, 9),PyTuple_GET_ITEM(argtuple, 10) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50_executor), NULL, __struct_compiled_op_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m2910d2b37adb1d0cfe111b4e8bcd09bacbe76deecbfae733933aac243b66ca50(void) {
   import_array();
