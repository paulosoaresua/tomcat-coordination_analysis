...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79() {
        ...
        ~__struct_compiled_op_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79(void) {
            cleanup();
        }
...
V1_iter = (npy_float64*)(PyArray_DATA(V1));
        ...
        for (int ITER_0 = V1_n0; ITER_0; ITER_0--) {
            
        
        for (int ITER_1 = V1_n1; ITER_1; ITER_1--) {
            
        npy_float64& V1_i = *V1_iter;
V1_i = 0;
        for (int ITER_2 = V3_n1; ITER_2; ITER_2--) {
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79_executor(__struct_compiled_op_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79_destructor(PyObject *capsule) {
            __struct_compiled_op_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79 *self = (__struct_compiled_op_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79* struct_ptr = new __struct_compiled_op_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79_executor), NULL, __struct_compiled_op_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m7a97a45758a0d27cb327db46ee0832947b10b068e97c8bb22f0bfeb9120a0b79(void) {
   import_array();
