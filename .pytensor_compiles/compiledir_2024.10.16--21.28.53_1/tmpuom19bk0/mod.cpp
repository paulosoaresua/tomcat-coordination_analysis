...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3() {
        ...
        ~__struct_compiled_op_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3(void) {
            cleanup();
        }
...
// Op class MakeVector
        ...
        npy_intp dims[1];
        dims[0] = 9;
        if(!V1 || PyArray_DIMS(V1)[0] != 9){
            Py_XDECREF(V1);
            V1 = (PyArrayObject*)PyArray_EMPTY(1, dims, PyArray_TYPE(V19), 0);
        }
        
            *((npy_float64 *)PyArray_GETPTR1(V1, 0)) = *((npy_float64 *) PyArray_DATA(V19));
            
            *((npy_float64 *)PyArray_GETPTR1(V1, 1)) = *((npy_float64 *) PyArray_DATA(V17));
            
            *((npy_float64 *)PyArray_GETPTR1(V1, 2)) = *((npy_float64 *) PyArray_DATA(V15));
            
            *((npy_float64 *)PyArray_GETPTR1(V1, 3)) = *((npy_float64 *) PyArray_DATA(V13));
            
            *((npy_float64 *)PyArray_GETPTR1(V1, 4)) = *((npy_float64 *) PyArray_DATA(V11));
            
            *((npy_float64 *)PyArray_GETPTR1(V1, 5)) = *((npy_float64 *) PyArray_DATA(V9));
            
            *((npy_float64 *)PyArray_GETPTR1(V1, 6)) = *((npy_float64 *) PyArray_DATA(V7));
            
            *((npy_float64 *)PyArray_GETPTR1(V1, 7)) = *((npy_float64 *) PyArray_DATA(V5));
            
            *((npy_float64 *)PyArray_GETPTR1(V1, 8)) = *((npy_float64 *) PyArray_DATA(V3));
            __label_21:
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3_executor(__struct_compiled_op_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3 *self) {
            return self->run();
        }

        static void __struct_compiled_op_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3_destructor(PyObject *capsule) {
            __struct_compiled_op_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3 *self = (__struct_compiled_op_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3* struct_ptr = new __struct_compiled_op_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8),PyTuple_GET_ITEM(argtuple, 9),PyTuple_GET_ITEM(argtuple, 10) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3_executor), NULL, __struct_compiled_op_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_me694b0ebe8208846601fecb3383d9a16facfcf6994c878ea1a2080496390d4b3(void) {
   import_array();
