                ...
                for model_name, baseline_model in [
                    ...
                    for s in range(1 if y_train.ndim == 2 else y_train.shape[0]):
                        ...
                        for f in range(y_train.shape[-2]):
                            y_train_single = (
                                y_train[s, f] if y_train.ndim > 2 else y_train[f]
                            )
                            y_train_single = sc_y.fit_transform(
                                y_train_single[:, None]
                            )[:, 0]

                            y_test_single = (
                                y_test[s, f] if y_test.ndim > 2 else y_test[f]
                            )
                            ...
                            mse = np.cumsum(
                                np.square(y_test_single - y_hat), axis=-1
