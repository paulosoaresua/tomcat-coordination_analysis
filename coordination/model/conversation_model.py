...
from coordination.module.serial_mass_spring_damper_component import \
    SerialMassSpringDamperComponent
...
class ConversationModel:
    ...
    def __init__(
        ...
        self.state_space_cpn = SerialMassSpringDamperComponent(
            uuid="state_space",
        ...
        self.observation_cpn = SerialObservation(
            uuid="observation",
    ...
    def draw_samples(
        ...
        observation_samples = self.observation_cpn.draw_samples(
            latent_component=state_samples.values, subjects=state_samples.subjects
        )
