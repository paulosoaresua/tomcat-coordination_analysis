...
class BrainModel:
    ...
    def __init__(self, subjects: List[str], brain_channels: List[str], self_dependent: bool, sd_mean_uc0: float,
                 ...
                 sd_sd_o: np.ndarray, a_mixture_weights: np.ndarray, share_mean_a0_across_subjects: bool,
                 share_mean_a0_across_features: bool, share_sd_aa_across_subjects: bool,
                 share_sd_aa_across_features: bool, share_sd_o_across_subjects: bool, share_sd_o_across_features: bool,
    ...
    def _define_pymc_model(self, evidence: BrainSeries):
        ...
        with pymc_model:
            ...
            latent_brain, _, _, _ = self.latent_brain_cpn.update_pymc_model(
                ...
                num_time_steps=evidence.num_time_steps_in_brain_scale)
