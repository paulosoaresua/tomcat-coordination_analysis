...
class GaussianLatentComponent(LatentComponent, ABC):
    ...
    @property
    def zero_noise(self) -> bool:
        """
        Checks whether the noise in the transition is zero.

        @return: true if noise variable is set and it's zero.
        """
        return self.parameters.sd_a.value is not None and self.parameters.sd_a.value == 0
    ...
    def create_random_variables(self):
        ...
        with self.pymc_model:
            ...
            if self.sd_a_random_variable is None and not self.zero_noise:
                dim_subjects = (
