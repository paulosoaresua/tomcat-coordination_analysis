...
def logp(
    ...
    """
    This function computes the log-probability of a non-serial component. We use the following
...
def random(
    ...
    """
    This function generates samples from of a non-serial component for prior predictive checks. We
    use the following definition in the comments below:
...
class NonSerialComponentSamples:
    def __init__(self):
        ...
        # For each time step in the component's scale, it contains the matching time step in the
        # coordination scale
...
class NonSerialComponent:
    """
    This class models a non-serial latent component which individual subject's dynamics influence
    that of the other subjects as controlled by coordination.
    """
    ...
    def __init__(
        ...
        self.parameters = NonSerialComponentParameters(
    ...
    def draw_samples(
        ...
        samples.time_steps_in_coordination_scale = (
            np.arange(num_time_steps_in_cpn_scale) * relative_frequency
        ).astype(int)
    ...
    def _create_random_parameters(
        self, mean_a0: Optional[Any] = None, sd_aa: Optional[Any] = None
    ):
        """
        This function creates the initial mean and standard deviation of the serialized component
    ...
    def update_pymc_model(
        ...
        non_serial_component = pm.CustomDist(
            self.uuid,
            *logp_params,
            logp=logp_fn,
            random=random_fn,
