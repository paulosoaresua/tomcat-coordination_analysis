...
class SerialMassSpringDamperComponent(SerialComponent):
    def __init__(
        ...
        damper system. We do not consider external force in this implementation but it can be
        ...
        for t in range(num_time_steps):
            ...
            if prev_time_same_subject[t] < 0:
                ...
                if self.self_dependent:
                    ...
                    # previous value of another subject, or it is samples around a fixed mean.
