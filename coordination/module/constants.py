...
DEFAULT_UNB_COORDINATION_MEAN_PARAM = 0.0
DEFAULT_UNB_COORDINATION_SD_PARAM = 1.0
DEFAULT_SAMPLING_TIME_SCALE_DENSITY = 1.0
DEFAULT_SAMPLING_RELATIVE_FREQUENCY = 1.0
...
DEFAULT_MLP_MEAN_WEIGHTS = 0.0
DEFAULT_MLP_SD_WEIGHTS = 1.0
