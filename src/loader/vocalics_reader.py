    ...
    def read(self,
        ...
        with self._connect() as connection:
            ...
            if baseline_time is not None:
                ...
                earliest_vocalics_timestamp = parse(
                    VocalicsReader._read_earliest_timestamp(connection, trial_metadata.id))
            ...
            for subject_id in vocalics_per_subject.keys():
                vocalics_series_per_subject[subject_id] = VocalicsSeries(
                    np.concatenate(vocalics_per_subject[subject_id][0], axis=1), vocalics_per_subject[subject_id][1])
